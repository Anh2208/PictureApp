...
CREATE TABLE `Friends` (
    `id` VARCHAR(191) NOT NULL,
    `MyId` VARCHAR(191) NOT NULL,
    `lastMessage` VARCHAR(191) NULL,
    `MyFriendId` VARCHAR(191) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Friends` ADD CONSTRAINT `Friends_MyId_fkey` FOREIGN KEY (`MyId`) REFERENCES `User`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
