...
const ChangePassword = ({ onClose }: ChangeState) => {
  ...
  const handlerSubmit: MouseEventHandler<HTMLButtonElement> = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (errorData == "Password don't match") {
                ...
                <div className="mx-4">
                  <div className="p-4">
                    <div className="mr-3 ml-2 mb-2 w-[calc(4/12*100%)]">
                      <label htmlFor="changePasswordOld">
                    ...
                    <div className="">
                      <span>
                        <div className=" relative block box-border">
                          <div className=" relative">
                            <input
                              type={changePasswordOld ? "password" : "text"}
                              id="changePasswordOld"
                              name="new"
                              spellCheck="false"
                              onChange={handlerPasswordOld}
                              ...
                              <div className=" box-border inline-block">
                                <div className="block box-border">
                                  <div
                                    ...
                                    onClick={() =>
                                      setChangePasswordOld((prev) => !prev)
                                    }
                                  >
