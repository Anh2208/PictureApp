...
export default function Home() {
  ...
  const snapOneRef = useRef<HTMLDivElement | null>(null);

  const handleScrollToTop = () => {
    if (snapOneRef.current) {
      snapOneRef.current.scrollIntoView({ behavior: "smooth" });
    }
  };
  ...
  return (
    <div className="snap-y snap-mandatory h-screen overflow-auto no-scrollbar">
      ...
      <div
        ref={snapOneRef}
        className="snap-center h-screen justify-center items-center bg-customColor-rgb_255_253_146 relative"
      >
      ...
      {/* snap 05 */}
      <div className="snap-center h-screen bg-white relative overflow-hidden">
